/**
 * =============================================================================
 * CONFIGURAZIONE CENTRALE — ALMEYDA (SIRACUSA)
 * =============================================================================
 * Tutti i dati del locale (testi, contatti, menu, foto e link) sono raccolti qui.
 * Puoi modificare facilmente qualsiasi valore senza toccare il layout grafico.
 */

import { BusinessConfig, Cocktail, Dish, GalleryItem } from '../types';

export const businessConfig: BusinessConfig = {
  businessName: "ALMEYDA",
  tagline: "Cocktail · Dining · Siracusa",
  city: "Siracusa",
  heroHeadline: "Un luogo dove cocktail, cucina e atmosfera si incontrano.",
  heroDescription: "Un ambiente contemporaneo e raffinato nel cuore di Siracusa. Dalla mixology d'autore alla cucina da condividere, per vivere la sera con il giusto ritmo.",
  
  introHeading1: "Non è solo una cena.",
  introHeading2: "Non è solo un cocktail.",
...
// =============================================================================
// CARTA COCKTAIL (PLACEHOLDER DIMOSTRATIVI — FACILMENTE SOSTITUIBILI)
// =============================================================================
...
// =============================================================================
// CARTA DINING (PLACEHOLDER DIMOSTRATIVI — FACILMENTE SOSTITUIBILI)
// =============================================================================
...
// =============================================================================
// GALLERY IMMAGINI & ATMOSFERA (PLACEHOLDER SOSTITUIBILI)
// =============================================================================
...
export const atmospherePhotos = [
  {
    url: "https://images.unsplash.com/photo-1543007630-9710e4a00a20?q=80&w=1000&auto=format&fit=crop",
  ...
  {
    url: "https://images.unsplash.com/photo-1578474846511-04ba529f0b88?q=80&w=1000&auto=format&fit=crop",
